...
public class Veterinario extends Persona{
    ...
    public Veterinario(String email, String telefono, String ruolo, Map<String,String> indirizzo, String nome, String cognome, String dataDiNascita, String numEFNOVI, String partitaIva) {
        super(email, telefono,  ruolo, indirizzo, nome, cognome, dataDiNascita);
